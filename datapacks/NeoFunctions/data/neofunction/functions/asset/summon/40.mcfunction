# 名称：=/function neofunction:asset/summon/40
...
# 説明：TEST
# タグ：
summon pig ~ ~ ~ {Passengers:[{id:"minecraft:pig",CustomName:'{"text":"TESTPIG2"}'}],CustomName:'{"text":"TESTPIG"}',Tags:[lv0,],DeathLootTable:"neofunction:entity/40"}